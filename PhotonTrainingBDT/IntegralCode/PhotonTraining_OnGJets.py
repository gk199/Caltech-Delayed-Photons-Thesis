...
test_name = 'Photons_modelGMSB_QCD_ECAL'
...
#GMSB vs GJets
gr4 = root.TGraph(n, eff_GJets,eff_GJets)
...
plt.figure()
lw = 2
plt.plot(eff_bkg, eff_sig, color='blue',
         lw=lw, label=r'$c\tau$ = 200cm, $\Lambda$ = 250 TeV, with ECAL timing')
...
plt.figure()
lw = 2
plt.plot(eff_GJets, eff_sig, color='blue',
         lw=lw, label=r'GMSB vs $\gamma$+jets, with ECAL timing')
plt.plot([0, 1], [0, 1], color='navy', lw=lw, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
#plt.grid()
...
plt.figure()
lw = 2
plt.plot(eff_bkg, eff_GJets, color='blue',
         lw=lw, label=r'$\gamma$+jets vs QCD, with ECAL timing')
plt.plot([0, 1], [0, 1], color='navy', lw=lw, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
#plt.grid()
