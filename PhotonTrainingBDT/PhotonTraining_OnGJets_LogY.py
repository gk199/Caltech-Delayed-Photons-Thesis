...
test_name = 'Photons_modelGMSB_QCD_Y'
...
plt.figure()
lw = 2
plt.semilogy(eff_bkg, eff_sig, color='darkorange',
...
plt.figure()
lw = 2
plt.semilogy(eff_GJets, eff_sig, color='darkorange',
         lw=lw, label=r'$c\tau$ = 200cm, $\Lambda$ = 250 TeV')
plt.plot([0, 1], [0, 1], color='navy', lw=lw, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
...
plt.figure()
lw = 2
plt.semilogy(eff_bkg, eff_GJets, color='darkorange',
