...
#signal
signalFileEffNames = {
    'Ctau10cm':'/afs/cern.ch/work/g/gkopp/Thesis/MC_Nov24_noIsoCut_barrelskim/GMSB_L150TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    'Ctau50cm':'/afs/cern.ch/work/g/gkopp/Thesis/MC_Nov24_noIsoCut_barrelskim/GMSB_L150TeV_Ctau50cm_13TeV-pythia8_pho1Pt_EB.root',
    'Ctau200cm':'/afs/cern.ch/work/g/gkopp/Thesis/MC_Nov24_noIsoCut_barrelskim/GMSB_L150TeV_Ctau200cm_13TeV-pythia8_pho1Pt_EB.root',
    'Ctau400cm':'/afs/cern.ch/work/g/gkopp/Thesis/MC_Nov24_noIsoCut_barrelskim/GMSB_L150TeV_Ctau400cm_13TeV-pythia8_pho1Pt_EB.root',
    }
...
#variablesHE = ['pho1ecalPFClusterIso','pho1trkSumPtHollowConeDR03','pho1PFsumNeutralHadronEt','pho1SigmaIetaIeta','pho1Smajor','pho1Sminor','pho1R9', 'pho1HoverE']
...
plt.title('Receiver operating characteristic - GMSB vs. QCD, Lambda = 150 TeV')
...
plt.show()
plt.savefig('myImportances_' + test_name + 'Ctau200cm' + '.png')
