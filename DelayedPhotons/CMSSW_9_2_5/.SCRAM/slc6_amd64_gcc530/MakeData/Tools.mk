...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/blackhat/0.9.9-mlhled2/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/boost/1.63.0-mlhled2/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/boost/1.63.0-mlhled2/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/boost/1.63.0-mlhled2/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/cascade/2.2.04-mlhled2/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/cgal/4.2-mlhled2/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/charybdis/1.003-mlhled2/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := root_cxxdefaults f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/classlib/3.1.3-oenich/include
...
ALL_TOOLS      += clhep
clhep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/clhep/2.3.4.2-mlhled2/include
clhep_EX_LIB := CLHEP
clhep_EX_USE := root_cxxdefaults
clhep_EX_FLAGS_CXXFLAGS  := -Wno-error=unused-variable

ALL_TOOLS      += clhepheader
clhepheader_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/clhep/2.3.4.2-mlhled2/include
clhepheader_EX_USE := root_cxxdefaults
clhepheader_EX_FLAGS_CXXFLAGS  := -Wno-error=unused-variable

ALL_TOOLS      += cmsswdata
cmsswdata_EX_FLAGS_CMSSW_DATA_PACKAGE  := CalibCalorimetry/CaloMiscalibTools=V01-00-00 CalibCalorimetry/EcalTrivialCondModules=V00-01-00 CalibTracker/SiPixelESProducers=V02-00-00 CalibTracker/SiStripDCS=V01-00-00 Calibration/Tools=V01-00-00 CondFormats/JetMETObjects=V01-00-03 Configuration/Generator=V01-00-01 DQM/PhysicsHWW=V01-00-00 DataFormats/PatCandidates=V01-00-01 DetectorDescription/Schema=V02-02-01 EventFilter/L1TRawToDigi=V01-00-00 FastSimulation/MaterialEffects=V05-00-00 FastSimulation/TrackingRecHitProducer=V01-00-02 Fireworks/Geometry=V07-05-03 GeneratorInterface/EvtGenInterface=V02-00-08 GeneratorInterface/ReggeGribovPartonMCInterface=V00-00-02 HLTrigger/JetMET=V01-00-00 L1Trigger/L1TCalorimeter=V01-00-21 L1Trigger/L1TGlobal=V00-00-07 L1Trigger/L1THGCal=V01-00-03 L1Trigger/L1TMuon=V01-00-10 L1Trigger/RPCTrigger=V00-15-00 MagneticField/Interpolation=V01-00-01 RecoBTag/CTagging=V01-00-03 RecoBTag/Combined=V01-00-04 RecoBTag/SecondaryVertex=V02-00-04 RecoBTag/SoftLepton=V01-00-01 RecoEgamma/ElectronIdentification=V01-00-07 RecoEgamma/PhotonIdentification=V01-00-04 RecoHI/HiJetAlgos=V01-00-01 RecoJets/JetProducers=V05-10-20 RecoLocalCalo/EcalDeadChannelRecoveryAlgos=V01-00-00 RecoMET/METPUSubtraction=V01-00-03 RecoMuon/MuonIdentification=V01-12-01 RecoParticleFlow/PFBlockProducer=V02-04-02 RecoParticleFlow/PFProducer=V15-00-00 RecoParticleFlow/PFTracking=V13-01-00 SLHCUpgradeSimulations/Geometry=V01-00-06 SimG4CMS/Calo=V03-01-00 SimG4CMS/Forward=V02-03-18 SimTracker/SiStripDigitizer=V01-00-00 SimTransport/HectorProducer=V01-00-01 Validation/Geometry=V00-07-00

ALL_TOOLS      += coral
ALL_SCRAM_PROJECTS += coral
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/coral/CORAL_2_3_21-njopjo2/include/LCG
...
ALL_TOOLS      += curl
curl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/curl/7.51.0-oenich/include
curl_EX_LIB := curl
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/davix/0.6.4-mlhled2/include/davix
davix_EX_LIB := davix
...
ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/dcap/2.47.8-oenich/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/eigen/3.3.0-oenich2/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/evtgen/1.6.0-njopjo/include
...
fastjet-contrib-archive_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/fastjet-contrib/1.026/include
...
fastjet-contrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/fastjet-contrib/1.026/include
...
ALL_TOOLS      += freetype
freetype_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/freetype/2.5.3-oenich/include
freetype_EX_LIB := freetype-cms
freetype_EX_USE := root_cxxdefaults

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/frontier_client/2.8.20-mlhled2/include
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/geant4/10.02.p02-mlhled2/include/Geant4
...
ALL_TOOLS      += giflib
giflib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/giflib/4.2.3-oenich/include
giflib_EX_LIB := gif
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/gmp-static/6.1.0-oenich/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
ALL_TOOLS      += hdf5
hdf5_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/hdf5/1.8.17-oenich/include
hdf5_EX_LIB := hdf5

ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/hector/1.3.4_patch1-njopjo/include
...
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/hepmc/2.06.07-oenich/include
hepmc_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/heppdt/3.03.00-oenich/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/herwig/6.521-mlhled2/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/herwigpp/7.0.4-njopjo/include
...
ALL_TOOLS      += ittnotify
ittnotify_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/ittnotify/16.06.18-oenich/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/jemalloc/4.5.0/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/jimmy/4.2-mlhled2/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/ktjet/1.06-mlhled2/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/lhapdf/6.1.6-mlhled2/include
...
ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/libpng/1.6.16-oenich/include
libpng_EX_LIB := png
libpng_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/libtiff/4.0.3-oenich/include
libtiff_EX_LIB := tiff
...
ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/libxml2/2.9.1-oenich/include/libxml2
libxml2_EX_LIB := xml2
libxml2_EX_USE := root_cxxdefaults

ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/libxslt/1.1.28-mlhled2/include/libxslt
libxslt_EX_LIB := xslt
...
llvm-cxxcompiler_EX_FLAGS_REM_CXXFLAGS  := -Wno-non-template-friend -Werror=format-contains-nul -Werror=maybe-uninitialized -Werror=unused-but-set-variable -Werror=return-local-addr -fipa-pta -frounding-math -mrecip -Wno-psabi -fno-crossjumping

ALL_TOOLS      += llvm-f77compiler
llvm-f77compiler_EX_USE := gcc-f77compiler

ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/llvm/4.0.0-njopjo/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/lwtnn/1.0-mlhled2/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/mctester/1.25.0a-njopjo/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/mpfr-static/3.1.3-oenich/include
mpfr_EX_LIB := mpfr

ALL_TOOLS      += openblas
openblas_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/OpenBLAS/0.2.19-mlhled2/include
...
ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/pcre/8.37-oenich/include
pcre_EX_LIB := pcre
...
ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/photospp/3.61-oenich/include
...
professor2_EX_USE := py2-numpy py2-sympy py2-matplotlib root cython yoda eigen

ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/protobuf/3.2.0/include
...
ALL_TOOLS      += py2-numpy-c-api
py2-numpy-c-api_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/py2-numpy/1.12.1-mlhled2/c-api/core/include
py2-numpy-c-api_EX_USE := python
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/pythia8/226/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/python/2.7.11-mlhled2/include/python2.7
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/rivet/2.5.2-njopjo/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.08.07/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.08.07/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/lcg/root/6.08.07/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/cern.ch/work/g/gkopp/DelayedPhotons/CMSSW_9_2_5/src /afs/cern.ch/work/g/gkopp/DelayedPhotons/CMSSW_9_2_5/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_9_2_5/src /cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_9_2_5/include/LCG
self_EX_LIBDIR := /afs/cern.ch/work/g/gkopp/DelayedPhotons/CMSSW_9_2_5/lib/slc6_amd64_gcc530 /afs/cern.ch/work/g/gkopp/DelayedPhotons/CMSSW_9_2_5/external/slc6_amd64_gcc530/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_9_2_5/lib/slc6_amd64_gcc530 /cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/cmssw/CMSSW_9_2_5/external/slc6_amd64_gcc530/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/sherpa/2.2.2-njopjo/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/sigcpp/2.6.2-oenich/include/sigc++-2.0
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/sqlite/3.15.1/include
sqlite_EX_LIB := sqlite3
sqlite_EX_USE := root_cxxdefaults

ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/starlight/r193-mlhled2/include
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/tauolapp/1.1.5-njopjo/include
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/thepeg/2.0.4-njopjo/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/tinyxml/2.5.3-mlhled2/include
tinyxml_EX_LIB := tinyxml

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/tkonlinesw/4.1.0-1-njopjo/include
...
ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/utm/utm_0.6.5/include
utm_EX_LIB := tmeventsetup tmtable tmxsd tmgrammar tmutil
utm_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/valgrind/3.12.0-oenich/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/cms/vdt/v0.3.2-oenich2/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/xrootd/4.6.1.RC2/include/xrootd /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/xrootd/4.6.1.RC2/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xz
xz_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/xz/5.2.1-oenich/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/yaml-cpp/0.5.1-mlhled2/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/yoda/1.6.5-njopjo/include
yoda_EX_LIB := YODA
yoda_EX_USE := python cython root_cxxdefaults

ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/zlib-x86_64/1.2.11/include
zlib_EX_LIB := z
